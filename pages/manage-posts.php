...
<div class="container mx-auto my-5" style="max-width: 700px;">
    ...
    <div class="card mb-2 p-4" style="border: 2px solid maroon;">
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">ID</th>
        ...
        <div class="text-center">
            <a href="/manage-posts-add" class="btn btn-primary btn-lg">Add New Post</a>
        </div>
    </div>
    <div class="text-center">
        <a href="/home" class="btn btn-link btn-sm"><i class="bi bi-arrow-left"></i> Back to Home</a>
    </div>
</div>
<?php
